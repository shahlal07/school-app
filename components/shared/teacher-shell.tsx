...
export function TeacherShell({ children, teacherName }: TeacherShellProps) {
  ...
  const navItems = [
    { label: t("nav.home"), href: "/teacher", icon: "home" as const },
    { label: t("nav.attendance"), href: "/teacher/attendance", icon: "user" as const },
    { label: t("nav.exams"), href: "/teacher/exams", icon: "book-open" as const },
    { label: t("nav.alerts"), href: "/teacher/alerts", icon: "bell" as const },
    { label: t("nav.messages"), href: "/teacher/messages", icon: "message-circle" as const }
  ].map((item) => ({
    ...item,
