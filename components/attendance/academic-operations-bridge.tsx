    ...
    <div className="mt-6">
      <section className="rounded-2xl border border-neutral-200 bg-white shadow-sm">
        <div className="border-b border-neutral-100 px-4 py-4 sm:px-5">
          <div className="flex flex-wrap items-center justify-between gap-2"><div><p className="text-xs font-semibold uppercase tracking-wide text-neutral-400">Academic operations</p><h2 className="mt-1 text-lg font-semibold text-neutral-900">Attendance ↔ Examination</h2><p className="mt-1 text-xs text-neutral-500">Daily attendance explains academic risk; exam attendance explains whether a result should exist.</p></div><Link href={attendanceHref} className="text-xs font-semibold text-primary-600">Open attendance center</Link></div>
        </div>
