...
interface AlertCardProps {
  ...
  /** Show the "which teacher this is about" line. Owner side only - a
   * teacher already knows who they are. */
  showTeacher?: boolean;
  /** When present, renders a Resolve button (owner-only capability). */
