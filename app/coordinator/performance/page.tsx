...
/**
 * Full mirror of app/owner/performance/page.tsx. This is naturally
 * read-only (there is no write action on this page for owner either), and
 * academic_coordinator has can_view_school_wide() read access on
 * test_results/schedule_items/chapters/topics, so no permission narrowing
 * is needed here unlike the papers page.
 */
