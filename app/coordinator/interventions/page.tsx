...
export default async function CoordinatorInterventionsPage(){
  ...
  return <main className="flex flex-col gap-5 p-4 sm:p-6">
    ...
    <Card><CardHeader><CardTitle>Create intervention</CardTitle></CardHeader><CardContent><form action={submitIntervention} className="grid gap-3 sm:grid-cols-2">
