...
interface ExamPaperRow { id:string; schedule_item_id:string; status:ExamPaperStatus; content:string|null; file_path:string|null; submitted_at:string|null; reviewed_at:string|null; review_notes:string|null; current_version:number; }
